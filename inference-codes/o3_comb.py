...
SAVED_PATH = "/home/ComplexPrompt/src/properties-eval/codes/output/o3_commonsenseqa_combined.csv"
...
with open(FILE_PATH) as file:
    ...
    for sample in tqdm(data):
        ...
        pol_ger_ans = get_answer_with_retry(pol_ger_prompt)
        mt_rw_ans = get_answer_with_retry(mt_rw_prompt)
        pol_ger_mt_ans = get_answer_with_retry(pol_ger_mt_prompt)
