...
# SAVED_PATH = "inference-codes/output/qwen/formal/formal_qwen_commonsenseqa_ans_ver12_dot_continued.csv"
SAVED_PATH = "inference-codes/output/qwen/original/qwen_commonsenseqa_ans_ver12_dot.csv"
CHOICES = "ABCDEFGH"
